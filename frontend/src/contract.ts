/**
 * Sorters Contract Integration
 * Example TypeScript integration for the Sorters smart contract
 */
...
export const CONTRACT_NAME = process.env.NEXT_PUBLIC_CONTRACT_NAME || 'sorters';
 ...
 * Use with Stacks Connect or similar transaction library
 */
